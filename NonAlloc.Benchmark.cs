...
namespace Medicine
{
    ...
    {
        /// <summary>
        /// Utility struct for conveniently easily measuring the duration of execution of a
        /// code fragment.
        /// </summary>
        /// <example>
        /// using (NonAlloc.Benchmark.Start("GetComponentsGeneric"))
        /// {
        ///     MyExpensiveOperations();
        ///     // duration is automatically logged to console when we go out of scope
        /// }
        /// </example>
        [UsedImplicitly]
