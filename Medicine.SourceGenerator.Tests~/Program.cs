...
[
    ...
    Med016Test.Case,
    Med017Test.Case,
    Med017Test.InheritedInterfaceCase,
    Med019Test.Case,
    Med020Test.Case,
    Med021Test.Case,
    Med022Test.Case,
    ...
    Med034Test.Case,
    Med035Test.Case,
    Med035Test.DestroyCase,
    Med035Test.DestroyImmediateCase,
    Med036Test.TrackCase,
    Med036Test.SingletonCase,
    Med036Test.InjectCase,
    InjectSourceGeneratorTest.Case,
    TrackSourceGeneratorTest.Case,
    TrackSourceGeneratorTest.CacheEnabledStateInheritanceCase,
    TrackSourceGeneratorTest.ImplicitInstanceIndexCase,
    TrackSourceGeneratorTest.ExecuteAlwaysMetadataCase,
    TrackSourceGeneratorTest.InterfaceInstanceIndexCase,
    TrackSourceGeneratorTest.GenericInheritanceRegistrationCase,
    TrackSourceGeneratorTest.InheritedMemberHidingCase,
    ...
    TrackSourceGeneratorTest.NonTrackedInterfaceUnmanagedPropagationCase,
    TrackSourceGeneratorTest.TrackedInterfaceUnmanagedNoImplicitClassPropagationCase,
    TrackSourceGeneratorTest.NonTrackedInterfaceUnmanagedNoDerivedClassInheritanceCase,
    TrackSourceGeneratorTest.ExplicitClassUnmanagedAlongTrackedInterfaceCase,
    ...
    UnionSourceGeneratorTest.SignatureAwareDispatchCase,
    UnionSourceGeneratorTest.NonNullableReferenceConstructorInitializerCase,
    UnionSourceGeneratorTest.WrapperCase,
    UnionSourceGeneratorTest.SerializedWrapperCase,
    ...
    UnmanagedAccessSourceGeneratorTest.GenericProjectionCase,
    UnmanagedAccessSourceGeneratorTest.GenericOpenReferenceStorageCase,
    UnmanagedAccessSourceGeneratorTest.GenericReferenceConstrainedCase,
    UnmanagedAccessSourceGeneratorTest.GenericUnsupportedValueCase,
    UnmanagedAccessSourceGeneratorTest.GenericPack1ValueCase,
    UnmanagedAccessSourceGeneratorTest.ManagedValueTypeProjectionCase,
    UnmanagedAccessSourceGeneratorTest.NullableValueTypeProjectionCase,
    UnmanagedAccessSourceGeneratorTest.UnmanagedAliasProjectionCase,
    UnmanagedAccessSourceGeneratorTest.CastHelperCase,
    UnmanagedAccessSourceGeneratorTest.AccessROPartialForwardingCase,
    ...
    UnmanagedInvokeSourceGeneratorTest.StaticCase,
    ...
    ConstantsSourceGeneratorTest.CustomNamespaceAndClassCase,
